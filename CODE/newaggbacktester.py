...
all_data = pd.read_csv('all_stock_data2023_10_08to2024_12_06polymulti.csv', index_col=0, parse_dates=True)
...
file_path = 'pairsfor2023_2024.txt'
...
with open('pair_trading_results_2023_10_08to2024_12_06.txt', 'w') as f:
...
with open('pair_trading_results_2023_10_08to2024_12_06more.txt', 'w') as f:
    for result in sorted_results:
        f.write(f'{result}\n')
